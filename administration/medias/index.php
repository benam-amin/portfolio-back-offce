...
// Requête SQL pour récupérer les médias avec leur catégorie associée
$requete = "SELECT medias.id, medias.titre, medias.label, medias.lien, medias.alt, categories.nom 
            FROM medias
                        ...
                        <?php if (mysqli_num_rows($resultat) > 0) { 
                            while ($entite = mysqli_fetch_assoc($resultat)) { ?>
                                <tr class="text-center border-b">
                                    ...
                                    <td class="px-6 py-3">
                                        <?php echo htmlspecialchars($entite["lien"]); ?>
                                    </td>
